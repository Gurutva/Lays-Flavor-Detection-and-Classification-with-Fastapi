...
class LaysDetector:
    ...
    def draw_detection(self , detected_images ):
        img = self.imgPath
        ans_image = []
        self.model.eval()
...
#           print(boxes)
            ...
            print('Detected box {0}'.format(element)," : ",flv_name,' || detect:',detection_score,' || flv :',flv_score)
...
if __name__ == "__main__":
    detector = LaysDetector(imgPath= "test2.jpeg")
